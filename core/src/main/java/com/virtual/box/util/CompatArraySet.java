 ...
 */
public final class CompatArraySet<E> implements Collection<E>, Set<E> {
    ...
    int mSize;
    private CompatMapCollections<E, E> mCollections;

    private int binarySearch(int[] hashes, int hash) {
        try {
            return binarySearch(hashes, mSize, hash);
     ...
     */
    public CompatArraySet(int capacity) {
        this(capacity, false);
    }

    /** {@hide} */
    public CompatArraySet(int capacity, boolean identityHashCode) {
     ...
     */
    public CompatArraySet(CompatArraySet<E> set) {
        this();
        if (set != null) {
            addAll(set);
        }
     ...
     */
    public CompatArraySet(Collection<? extends E> set) {
        this();
        if (set != null) {
            addAll(set);
        }
     ...
     */
    public CompatArraySet(@Nullable E[] array) {
        this();
        if (array != null) {
            for (E value : array) {
                add(value);
     ...
     */
    public void addAll(CompatArraySet<? extends E> array) {
     ...
     */
    public boolean removeAll(CompatArraySet<? extends E> array) {
    ...
    private CompatMapCollections<E, E> getCollection() {
        if (mCollections == null) {
            mCollections = new CompatMapCollections<E, E>() {
                @Override
