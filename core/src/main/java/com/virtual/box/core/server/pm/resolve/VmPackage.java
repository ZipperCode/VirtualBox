 ...
 * 主要用于存储包解析后的数据
 */
public class VmPackage implements Parcelable {
    ...
    public VmPackage(PackageParser.Package aPackage) {
...
//        this.mExtras = in.readParcelable(BPackageSettings.class.getClassLoader());
    ...
    public final static class Activity extends Component<ActivityIntentInfo> {
        ...
        public Activity(Parcel parcel) {
            ...
            while (N-- > 0) {
                IntentInfo intentInfo = parcel.readParcelable(VmPackage.class.getClassLoader());
    ...
    public static class IntentInfo implements Parcelable {
        ...
        protected IntentInfo(Parcel in) {
            this.intentFilter = in.readParcelable(VmPackage.class.getClassLoader());
...
//        dest.writeParcelable(this.mExtras, flags);
    ...
    public static final Creator<VmPackage> CREATOR = new Creator<VmPackage>() {
        @Override
        public VmPackage createFromParcel(Parcel source) {
            return new VmPackage(source);
        }

        @Override
        public VmPackage[] newArray(int size) {
            return new VmPackage[size];
        }
    };
}
