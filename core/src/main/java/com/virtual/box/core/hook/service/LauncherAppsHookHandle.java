...
public class LauncherAppsHookHandle extends BaseBinderHookHandle{
    ...
    LauncherActivityInfoInternal resolveLauncherActivityInternal(MethodHandle methodHandle,
                                                                 String callingPackage, ComponentName component, UserHandle user){
        // TODO
        return (LauncherActivityInfoInternal) methodHandle.invokeOriginMethod();
    }
    ...
    ParceledListSlice<?> getShortcuts(MethodHandle methodHandle,String callingPackage, ShortcutQueryWrapper query,
                                   UserHandle user){
     ...
     */
    void registerShortcutChangeCallback(MethodHandle methodHandle,String callingPackage, ShortcutQueryWrapper query,
                                        IInterface callback){
        methodHandle.invokeOriginMethod(new Object[]{
